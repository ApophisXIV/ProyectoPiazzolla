...
// smalltalk
//     .prompt('Question', 'Ingrese su latitud por favor', null)
//     .then((value) => {
//         console.log(value);
//     })
//     .catch(() => {
...
//L.marker([position.coords.latitude, position.coords.longitude], {draggable: false, icon: baseMarcador}).addTo(map);
//}
//else{
